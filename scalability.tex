...
% Another explanation for kappa is not crosstalk/coherency, but queue
% management. See Little's "50 years later" paper. A reasonable cost for queue
% management would be O(log n). This would make service times increase
% logarithmically instead of quadratically.
